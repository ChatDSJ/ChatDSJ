...
class Settings(BaseSettings):
    ...
    max_context_tokens_general: int = Field(20000, description="Max context tokens for general tasks")
    ...
    max_context_tokens_content_summary: int = Field(25000, description="Max context tokens for content summaries")
